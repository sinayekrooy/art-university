...
class page
{
	...
	public function list_groups($parent_id, $menu_id)
	{
		$has_childs = false;
		...
		foreach($menu_array as $item => $colum)
		{
			if ($colum['parent'] == $parent_id and $colum['menu'] == $menu_id) 
			{
				...
				$this->list_groups($colum['id'], $menu_id);
				echo '</li>';
			}
		}
	...
	private function fetch_parent($child_id)
	{			
	...
	public function scroll_groups($parent)
	{
		global $scroll_items;
	...
	public function top_menu($page_id)
	{
		global $connection;
	...
	public function side_menu($page_id)
	{
		global $connection;
	...
	public function menus_list($page_id)
	{
		global $connection;
	...
	public function parent_list($menu_id)
	{
		global $connection;
		global $scroll_items;
