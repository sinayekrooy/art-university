	...
	<script>
		...
		xmlhttp.onreadystatechange=function()
		  ...
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			{
			if(str1=="pages2")
				document.getElementById("load_sub_menus").innerHTML=xmlhttp.responseText;
			else
				document.getElementById("load_menus").innerHTML=xmlhttp.responseText;
			}
		  }
		if(str1=="pages2")
			var str=document.getElementById("selectError1").value;
		else
			var str=document.getElementById("selectError").value;
		xmlhttp.open("GET","load_menus.php?q="+str+"&method="+str1,true);
		xmlhttp.send();
		}
</script>
		...
		<div class="row-fluid">
					...
					<div class="box-content">
						<form action="" method="post" name="newsform" >
							<div class="control-group">
								<label class="control-label" for="focusedInput"> عنوان زیر منو </label>
								<div class="controls">
                            ...
                            <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError" onchange="showmenus('pages');" data-rel="chosen">
                                  <?php page_list(); ?>
								  </select>
								</div>
							 </div>
							 <div class="control-group" id="load_menus">
							 </div>
							 <div class="control-group" id="load_sub_menus">
							 </div>
							 
							<div class="control-group">
								<label class="control-label" for="appendedInput">آدرس صفحه مربوطه را وارد کنید و یا اگر خواستار ایجاد صفحه جدید هستید متن را وارد نمایید</label>
								<div class="controls">
								  <div class="input-append">
									<div class="control-group">
										<div class="controls">
										  <label class="checkbox inline">
											<input type="checkbox" onclick="en_disable();" id="inlineCheckbox1">
										  </label>
										</div>
									 </div>
									<input id="appendedInput" disabled size="16" type="text"><span class="add-on">http://</span>
								  </div>
								</div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="textarea2"> محتوای صفحه </label>
							  <div class="controls">
			...
			function en_disable ()
			{
				if(document.getElementById("inlineCheckbox1").checked)
					document.getElementById("appendedInput").disabled=false;
				else
					document.getElementById("appendedInput").disabled=true;
			}
			</script>
			</div><!--/row-->
