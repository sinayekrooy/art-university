...
$sql="insert into `news` (`title`,`abstract`,`description`,`datetime`,`category`) values ('$_POST[title]','$_POST[abstract]','$_POST[description]','$_POST[date_time]','$tags')";
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i> درج خبر جدید </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form action="" method="post" name="newsform" >
							<div class="control-group">
								<label class="control-label" for="focusedInput">عنوان خبر</label>
								<div class="controls">
								  <input class="input-xlarge focused" name="title" id="focusedInput" type="text" placeholder="عنوان خبر را در اینجا وارد کنید...">
								</div>
							  </div>
                              <label class="control-label" for="abstract">چکیده خبر</label>
                            <textarea cols="50" rows="4" id="abstract" name="abstract" name="abstract" placeholder="abstract" ></textarea><br  />
                            <div class="control-group">
							  <label class="control-label" for="textarea2">متن کامل خبر</label>
							  <div class="controls">
								<textarea class="cleditor" name="description" id="textarea2" rows="3"></textarea>
							  </div>
							</div>
                            تاریخ 
                            <input type="text" name="date_time" id="datepicker2" />
            				<input type="text" id="alternate2" size="30" />
                            <div class="control-group">
								<label class="control-label" for="selectError1">برچسب ها </label>
								<div class="controls">
							...
							<input type="submit" class="btn btn-primary" value="ثبت خبر"  />
